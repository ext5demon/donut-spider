...
struct GMLArray {
    ...
    int32_t refCount;
    void* owner;
    // Heap-registry metadata used by the cycle-collecting mark-and-sweep pass.
    // Reference counting still reclaims the common acyclic case immediately.
    int32_t gcRegistryIndex;
    bool gcMarked;
    bool gcGarbage;
    union {
        struct {
...
// Internal heap-registry API used by gml_gc.c.
